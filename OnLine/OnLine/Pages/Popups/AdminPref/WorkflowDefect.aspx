<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Popups/AdminPref/WorkFlow.Master" AutoEventWireup="true" CodeBehind="WorkflowDefect.aspx.cs" Inherits="OnLine.Pages.Popups.AdminPref.WorkflowDefect" %>
    ...
    <asp:Panel ID="Panel_SLA" runat="server"
        ...
        <ContentTemplate>
            <asp:Panel ID="Panel4" runat="server" >
                Send update on defect Logging and Closure to customer from this Email Id:
...
&nbsp;
                ...
                <br />
                <br />
                Email body to be sent in messages when <strong>New defect is logged</strong>:
...
&nbsp;<asp:Button ID="Button_New_Email_Body" runat="server" class="btn btn-sm btn-success"
                ...
                <br />
                <br />
                Email body to be sent in messages when <strong>defect is Closed</strong>:
