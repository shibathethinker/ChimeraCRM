...
{
    public partial class AllRFQ_Location : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                if (approvalContext)
                {
                    ...
                    Label_Status.Text = "To Edit this location details, please check the details from Purchase-> RFQ screen";
                ...
                else
                {
                    Button_Update.Enabled = false;
                    Label_Status.Visible = true;
                    Label_Status.Text = "You dont have edit access to RFQ records";
                    Label_Status.ForeColor = System.Drawing.Color.Red;
                }
                String localId = Session[SessionFactory.ALL_PURCHASE_ALL_RFQ_LOCATION].ToString();
    ...
    !DropDownList_State.SelectedValue.Equals("") ? DropDownList_State.SelectedValue : DropDownList_Country.SelectedValue;
            ...
            targetVals.Add(BackEndObjects.RFQDetails.RFQ_COL_LOCAL_ID, localId);
            ...
            try
            {
                ...
                Session[SessionFactory.ALL_PURCHASE_ALL_RFQ_LOCATION] = localId;
                loadLocalityDetails(localId);
            }
            catch (Exception ex)
            {
