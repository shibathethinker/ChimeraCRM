    ...
    public partial class CreateSR : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                Session[SessionFactory.ALL_SR_CREATE_SR_RFQ_AUTOCOMPLETE_LIST] = rfqNameArray;
                }
                if (invList != null)
                {
                    ...
                    Session[SessionFactory.ALL_SR_CREATE_SR_INV_AUTOCOMPLETE_LIST] = invNameArray;
                    Session[SessionFactory.ALL_SR_CREATE_SR_INV_AMNT_DICT] = invAmount;
                }
        ...
        {
            String[] rfqNameArray=((String[])HttpContext.Current.Session[SessionFactory.ALL_SR_CREATE_SR_RFQ_AUTOCOMPLETE_LIST]);
        ...
        {
            String[] invIdArray = ((String[])HttpContext.Current.Session[SessionFactory.ALL_SR_CREATE_SR_INV_AUTOCOMPLETE_LIST]);
        ...
        protected void hdnValue_ValueChangedRFQ(object sender, EventArgs e)
        {
            ...
            String[] rfqArray = (String[])Session[SessionFactory.ALL_SR_CREATE_SR_RFQ_AUTOCOMPLETE_LIST];
        ...
        protected void loadDefectStatAndResolStat()
        {
            ...
            {
                if (!((BackEndObjects.DefectResolStatCodes)defectResolStatList[i]).getResolStat().Equals("Not a Defect", StringComparison.InvariantCultureIgnoreCase))
                {
                    ListItem lt = new ListItem();
        ...
        protected void LinkButton1_Click(object sender, EventArgs e)
        {
            ...
            forwardString += "?parentContext=" + "sr";
        ...
        protected void Button_Submit_Defect_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Label_Status.Text="SR Entered Successfully";        
                
     
                DataTable dt=new DataTable();

                if (context.Equals("incoming"))
                    dt = (DataTable)Session[SessionFactory.ALL_SR_ALL_INCOMING_SR_GRID];
                else
                    dt = (DataTable)Session[SessionFactory.ALL_SR_ALL_OUTGOING_SR_GRID];
            ...
            catch (Exception ex)
            {
                ...
                Label_Status.Text = "SR Creation Failed";
            }
        }
            ...
            if (mBEObj.getSupportEmail() != null && !mBEObj.getSupportEmail().Equals("") && contactEmailList != null)
            {
                try
                {
                    ActionLibrary.Emails.sendEmail(
                        ...
                        "SR Logged with SR id#" + defId,
                        mBEObj.getNewSREmailBody());
                }
                catch (Exception ex)
                {
                }
        ...
        {
            Dictionary<String, String> invAmountDict = (Dictionary<String, String>)Session[SessionFactory.ALL_SR_CREATE_SR_INV_AMNT_DICT];
