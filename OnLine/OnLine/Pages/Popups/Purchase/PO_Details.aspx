<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PO_Details.aspx.cs" Inherits="OnLine.Pages.Popups.Purchase.PO_Details" %>
...
<body>
    ...
    <br />
        <asp:Panel ID="Panel_PO_Change_Warning" Visible="false" runat="server">
    
      <div class="alert alert-success">
        <strong>Note!</strong> You can edit or add more product/service details to this PO as no invoice has been issued against it yet
      </div>
        </asp:Panel>      
        ...
        <br />
            ...
            Text="Add Product Details" class="btn btn-sm btn-success"
                            ...
                            onclick="Button_Add_Prod_Srv_Click" Visible="False" />
                    <br />
                    <br />
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Product Details">
                            <EditItemTemplate>
                                ...
                                <ContentTemplate>
                                <asp:TextBox class="form-control" ID="TextBox_Prod_Name_Edit" runat="server" AutoPostBack="True" Width="90%" 
                                     style="font-family: Andalus" 
                                    Text='<%# Eval("Prod_Name") %>' 
                                        ontextchanged="TextBox_Prod_Name_Edit_TextChanged"></asp:TextBox>
                                    <asp:Label ID="Label_Prod_Name_Warning" runat="server" ForeColor="Red" 
                                        Text="Please provide unique name" Visible="False"></asp:Label>
...
&nbsp;
            ...
            &nbsp;
                        <asp:TextBox class="form-control" ID="TextBox_tax" runat="server" style="font-family: Andalus" AutoPostBack="True"  
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                                ...
                                                ValidationGroup="updatePO"></asp:RequiredFieldValidator>
        ...
        <ContentTemplate>
                    <asp:Button ID="Button_Update_PO_By_Client" runat="server" class="btn btn-sm btn-success"
                        onclick="Button_Update_PO_By_Client_Click" 
                        style="font-family: Andalus" Text="Update!" Visible="False" 
                        ValidationGroup="updatePO" />
        <br />
                    &nbsp;<br />
        ...
        <asp:Button ID="Button_Gen_PDF" runat="server" class="btn btn-sm btn-success"
                        onclick="Button_Gen_PDF_Click" 
                        style="font-family: Andalus" Text="Generate PDF!" />
