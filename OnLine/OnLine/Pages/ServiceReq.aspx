<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Site1.Master" AutoEventWireup="true" CodeBehind="ServiceReq.aspx.cs" Inherits="OnLine.Pages.ServiceReq" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolderBody" runat="server">
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <ContentTemplate>
                                                                ...
                                                                <asp:LinkButton ID="LinkButton_Incm_Collp" runat="server" ForeColor="White" 
                                                                        ToolTip="Click to expand or collapse">Service Requests Sent To Us</asp:LinkButton>
    ...
    <br />
            ...
            <div class="panel-heading">
              <h3 class="panel-title">Service Requests Sent To Us</h3>
            </div>
                ...
                <tr>
                    <td align="center">
                        ...
                        <asp:TextBox class="form-control" ID="TextBox_Inv_No_Incm_Defect" runat="server" 
                            style="font-family: Andalus" Width="20%"></asp:TextBox>
                        <br /><br />Request Severity:<asp:DropDownList class="form-control form-control-dropdown" ID="DropDownList_Incm_Defect_Sev" 
            ...
            <div align="center">
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    ...
                    <asp:Label ID="Label_Incm_msg" runat="server" Visible="False"></asp:Label>
                        <asp:GridView ID="GridView_Incoming_SR" 
                    ...
                    GridLines="None" 
                       ...
                       PageSize="5" Visible="False" 
                        style="font-size: small" Height="30%" Width="90%"                         
                            onpageindexchanging="GridView_Incoming_SR_PageIndexChanging" 
                            onrowcancelingedit="GridView_Incoming_SR_RowCancelingEdit" 
                            onrowdatabound="GridView_Incoming_SR_RowDataBound" 
                            onrowediting="GridView_Incoming_SR_RowEditing" 
                            onrowupdating="GridView_Incoming_SR_RowUpdating" 
                            onselectedindexchanged="GridView_Incoming_SR_SelectedIndexChanged" 
                            AllowSorting="True" onsorting="GridView_Incoming_SR_Sorting">                          
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Resolution Status">
                                    <ItemTemplate>
    ...
    <ContentTemplate>
                                                                ...
                                                                <asp:LinkButton ID="LinkButton_Outg_Collp" runat="server" ForeColor="White" 
                                                                        ToolTip="Click to expand or collapse">Service Requests Sent By Us</asp:LinkButton>
                                                                        <div style="float: right; vertical-align: middle;">
    ...
    <br />
               <div class="panel panel-primary" Width="95%">
            <div class="panel-heading">
              <h3 class="panel-title">Service Requests Sent By Us</h3>
            </div>
            <div class="panel-body">  
                        ...
                        <tr>
                            <td align="center">
                                ...
                                <asp:TextBox class="form-control" ID="TextBox_Inv_No_Outgoing_Defect" runat="server" 
                                    style="font-family: Andalus" Width="20%"></asp:TextBox>
                                <br /><br />Request Severity:<asp:DropDownList class="form-control form-control-dropdown" ID="DropDownList_Outg_Defect_Sev" 
                                    runat="server" style="font-family: Andalus">
                                </asp:DropDownList>
                                &nbsp;Request Status:
            ...
            <div align="center">
                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                    ...
                    <asp:Label ID="Label_Outg_msg" runat="server" Visible="False"></asp:Label>
                        <asp:GridView ID="GridView_Outgoing_SR" 
                        runat="server" AllowPaging="True" 
                    AutoGenerateColumns="False" CellPadding="4" 
                    GridLines="None" 
                                        CssClass="table table-striped table-bordered table-hover tableShadow" 
                    ...
                    PageSize="5" Visible="False" 
                        style="font-size: small" Height="30%" Width="90%"                         
                            onpageindexchanging="GridView_Outgoing_SR_PageIndexChanging" 
                            onrowcancelingedit="GridView_Outgoing_SR_RowCancelingEdit" 
                            onrowdatabound="GridView_Outgoing_SR_RowDataBound" 
                            onrowediting="GridView_Outgoing_SR_RowEditing" 
                            onrowupdating="GridView_Outgoing_SR_RowUpdating" 
                            onselectedindexchanged="GridView_Outgoing_SR_SelectedIndexChanged" 
                            AllowSorting="True" onsorting="GridView_Outgoing_SR_Sorting">
                                                       <Columns>
                                                           <asp:TemplateField>
                                                               <ItemTemplate>
                                                           ...
                                                           <asp:TemplateField HeaderText="Req Status">
                                                               <EditItemTemplate>
                                                                   &nbsp;
