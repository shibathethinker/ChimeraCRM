...
<body>
    ...
    <div>
        ...
        <ContentTemplate>
            ...
            <br />            
            <asp:TextBox ID="TextBox1" runat="server" Width="20%" CssClass="style1" MaxLength="200" placeholder="User Name"></asp:TextBox>
              ...
              &nbsp;
            <asp:TextBox ID="TextBox4" runat="server" Width="20%" CssClass="style1" MaxLength="100" placeholder="Email Id"></asp:TextBox>
            &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" 
              ...
              <br /> 
                        <br />                        
            <asp:TextBox ID="TextBox2" TextMode="Password" runat="server" Width="20%" CssClass="style1" placeholder="Passsword"
                  ></asp:TextBox>
              &nbsp;
              <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" 
                  ...
                  ValidationGroup="Panel1"></asp:RequiredFieldValidator>
              &nbsp;
            <asp:TextBox ID="TextBox3" TextMode="Password" runat="server" Width="20%" CssClass="style1" placeholder="Confirm Password"
                  ></asp:TextBox>
            ...
            site):&nbsp;
            <asp:TextBox ID="TextBox5" runat="server" Width="368px" CssClass="style1" MaxLength="50" ></asp:TextBox>
...
class="btn btn-sm btn-success"
    ...
    <asp:Panel ID="Panel2" runat="server" 
        ...
        &nbsp;Business owner name:
        <asp:TextBox ID="TextBox6" runat="server" Width="20%" CssClass="style1" 
        ...
        &nbsp;Website:
        <asp:TextBox ID="TextBox7" runat="server" Width="20%" CssClass="style1" ></asp:TextBox>
        ...
        &nbsp;<asp:RegularExpressionValidator ID="RegularExpressionValidator3" 
            ...
            <br />
            Contact No:
        <asp:TextBox ID="TextBox10" runat="server" Width="20%" MaxLength="14" ></asp:TextBox>
        ...
        <asp:DropDownList ID="DropDownListDescr" runat="server" 
            style="font-family: Andalus">
        </asp:DropDownList>
        ...
        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
            ...
            <div class="panel-body">   
                <asp:Panel ID="Panel3" runat="server" 
                    ...
                    &nbsp;Street Name:
                    <asp:TextBox ID="TextBox8" runat="server" Width="20%" CssClass="style1" ></asp:TextBox>
                </asp:Panel>
                </div>
                </div>
                <br />
        ...
        <asp:Panel ID="Panel4" runat="server" 
            ...
            <asp:ListBox ID="ListBoxProdServc" runat="server" Width="30%" 
                Height="67px" SelectionMode="Multiple" CssClass="style1" ></asp:ListBox>
