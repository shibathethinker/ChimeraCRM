<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreateReq.aspx.cs" Inherits="OnLine.Pages.CreateReq" %>
...
legend {color:red}
    ...
    <script language="javascript">
        function RefreshParent() {
            window.opener.document.getElementById('ContentPlaceHolderBody_Button_Req_Refresh_Hidden').click();
        }
    </script>
</head>
<body>
    ...
    <div align="center">
        ...
        <div class="panel-heading">
            <h3 class="style3">Create New Requirement</h3>
            </div>
    ...
    <asp:Panel ID="Panel2" runat="server"  
        ...
        <asp:Panel ID="Panel_Prod_Service_Det" runat="server" 
            ...
            <div >
                ...
                &nbsp;<asp:TextBox class="form-control" ID="TextBox_Spec" runat="server"  
                    Width="50%" Visible="False" MaxLength="200" TextMode="MultiLine"></asp:TextBox>
                <br />
                <br />
                ...
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                    ...
                    <Columns>
                        <asp:CommandField SelectText="Add To Requirement" ShowSelectButton="True" />
        ...
        <asp:Panel ID="Panel_Prod_Srv_Qnty" runat="server"
            ...
            &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator_Qnty_From" 
                ...
                ErrorMessage="Required" ForeColor="Red" ValidationGroup="Req_Validate"></asp:RequiredFieldValidator>
            &nbsp;<asp:RegularExpressionValidator ID="RegularExpressionValidator1" 
                runat="server" ControlToValidate="TextBox_Prod_Qnty_From" Display="Dynamic" 
                
                ErrorMessage="Please enter valid number (maximum 11 digits before decimal and 2 after decimal)" ForeColor="Red" 
                ValidationExpression="^(?:[1-9]\d{0,10})?(?:\.\d{0,2})?$" 
                ValidationGroup="Req_Validate"></asp:RegularExpressionValidator>
            ...
            &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator_Qnty_To" runat="server" 
                ControlToValidate="TextBoxrod_Qnty_To" Display="Dynamic" ErrorMessage="Required" 
        ...
        <asp:TextBox class="form-control" ID="TextBox_Reqr_Name" runat="server"  
            Width="50%" ValidationGroup="Req_Validate" MaxLength="100"></asp:TextBox>
        &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator_Req_Name" 
        ...
        <br />
                ...
                <div align="center">
                    ...
                    &nbsp;&nbsp;<asp:Button ID="Button_Submit_Extra_Prd_Srv" runat="server" class="btn btn-sm btn-success"
                        ...
                        Text="Add More Products/Services To This Requirement!" 
                    ...
                    <asp:Button ID="Button_Submit_Next" runat="server" class="btn btn-sm btn-success"
                        ...
                        Text="Submit and Next!" ValidationGroup="Req_Validate" />
