<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AllRequirement_Specification.aspx.cs" Inherits="OnLine.Pages.Popups.Purchase.AllRequirement_Specification" %>
            ...
            onrowdeleting="GridView1_RowDeleting">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="From Quantity">
                            ...
                            <EditItemTemplate>
                                <asp:TextBox class="form-control" ID="TextBox_From_Qnty_Edit" runat="server" 
                        ...
                        <asp:TemplateField HeaderText="To Quantity">
                            ...
                            <EditItemTemplate>
                                <asp:TextBox class="form-control" ID="TextBox_To_Qnty_Edit" runat="server" 
                        ...
                        <asp:TemplateField HeaderText="From Price">
                            ...
                            <EditItemTemplate>
                                <asp:TextBox class="form-control" ID="TextBox_From_Price_Edit" runat="server" 
                        ...
                        <asp:TemplateField HeaderText="To Price">
                            ...
                            <EditItemTemplate>
                                <asp:TextBox class="form-control" ID="TextBox_To_Price_Edit" runat="server" 
        ...
        <br />
                ...
                <div align="center">
                    <asp:Button ID="Button_Add_To_Req" runat="server" class="btn btn-sm btn-success"
                        onclick="Button_Add_To_Req_Click" style="font-family: Andalus" Text="Add" 
