...
namespace OnLine.Pages
{
    public partial class Defects : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                {
                    ((HtmlGenericControl)(Master.FindControl("Defects"))).Attributes.Add("class", "active");
                    ...
                    else if (accessList[BackEndObjects.EntityAccessListRecord.ENTITY_ACCESS_LIST_RECORD_ACCESS_DEFECTS_SCREEN_VIEW])
                    {
                        loadDefectStatAndResolStat();
                        loadIncomingDefectList(null);
                        loadOutgoingDefectList(null);
        ...
        protected void CheckAccessToActions()
        {
            ...
            {
                if (!accessList[BackEndObjects.EntityAccessListRecord.ENTITY_ACCESS_LIST_RECORD_ACCES_CREATE_INCOMING_DEFECT])
                    Button_Create_Defect_Incm.Enabled = false;
                if (!accessList[BackEndObjects.EntityAccessListRecord.ENTITY_ACCESS_LIST_RECORD_ACCES_CREATE_OUTGOING_DEFECT])
        ...
        !accessList[BackEndObjects.EntityAccessListRecord.ENTITY_ACCESS_LIST_RECORD_ACCESS_OWNER_ACCESS])
                    GridView_Incoming_Defects.Columns[1].Visible = false;
        ...
        protected void loadOutgoingDefectList(Dictionary<String, DefectDetails> defectDictPassed)
        {
            ...
            foreach (KeyValuePair<String, DefectDetails> kvp in defectDict)
            {
                ...
                if (defObj.getCreationMode().Equals(BackEndObjects.DefectDetails.DEFECT_CREATION_MODE_MANUAL))
                {
                    suplName = Contacts.getContactDetailsforContactEntityDB(Session[SessionFactory.MAIN_BUSINESS_ENTITY_ID_STRING].ToString(), suplId).getContactName();
    ...
    Substring(0, (defObj.getDescription().Length > 20 ? 20 : defObj.getDescription().Length - 1)) : "";
            ...
            GridView_Outgoing_Defects.SelectedIndex = -1;
            ...
            if (!accessList[BackEndObjects.EntityAccessListRecord.ENTITY_ACCESS_LIST_RECORD_ACCES_EDIT_OUTGOING_DEFECT] &&
                !accessList[BackEndObjects.EntityAccessListRecord.ENTITY_ACCESS_LIST_RECORD_ACCESS_OWNER_ACCESS])
                GridView_Outgoing_Defects.Columns[1].Visible = false;
        ...
        {
            String forwardString = "CreateDefect.aspx";
            forwardString += "?context=" + "incoming";

            ScriptManager.RegisterStartupScript(this, typeof(string), "createIncmDefectManual", "window.open('" + forwardString + "',null,'resizeable=yes,scrollbars=yes,addressbar=no,toolbar=yes,width=900,Height=900');", true);
        ...
        protected void GridView_Incoming_Defects_RowEditing(object sender, GridViewEditEventArgs e)
        {
           /* Dictionary<String, bool> accessList = (Dictionary<String, bool>)Session[SessionFactory.ACCESSLIST_FOR_USER];
            ...
            {*/
                ...
                GridView_Incoming_Defects.EditIndex = e.NewEditIndex;
                GridView_Incoming_Defects.DataSource = (DataTable)Session[SessionFactory.ALL_DEFECT_ALL_INCOMING_DEFECT_GRID];
                GridView_Incoming_Defects.DataBind();
                Label_Incm_msg.Visible = true;
                Label_Incm_msg.Text = "You can edit all the fields only if the defect is created by your organization";
                Label_Incm_msg.ForeColor = System.Drawing.Color.Green;
          /*  }
            else
            {
                GridView_Incoming_Defects.EditIndex = -1;
                GridView_Incoming_Defects.DataSource = (DataTable)Session[SessionFactory.ALL_DEFECT_ALL_INCOMING_DEFECT_GRID];
                GridView_Incoming_Defects.DataBind();
        ...
        protected void GridView_Incoming_Defects_RowCancelingEdit(object sender, GridViewCancelEditEventArgs e)
        {
            GridView_Incoming_Defects.EditIndex = -1;
            GridView_Incoming_Defects.DataSource = (DataTable)Session[SessionFactory.ALL_DEFECT_ALL_INCOMING_DEFECT_GRID];
            GridView_Incoming_Defects.DataBind();
        ...
        protected void GridView_Incoming_Defects_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
             String defectId = ((Label)GridView_Incoming_Defects.Rows[e.RowIndex].Cells[0].FindControl("Label_Defect_Id")).Text;
             BackEndObjects.DefectDetails defObj = BackEndObjects.DefectDetails.getDefectDetailsbyidDB(defectId);
            ...
            int index = GridView_Incoming_Defects.Rows[e.RowIndex].DataItemIndex;
            ...
            if (defObj.getCreationMode().Equals(BackEndObjects.DefectDetails.DEFECT_CREATION_MODE_MANUAL))
            {
                ...
                if (defObj.getCreatedByComp().Equals(Session[SessionFactory.MAIN_BUSINESS_ENTITY_ID_STRING].ToString()))
                {
                    ...
                    rfqNo = ((TextBox)GridView_Incoming_Defects.Rows[e.RowIndex].Cells[0].FindControl("TextBox_RFQ_No_Edit")).Text;
                    invNo = ((TextBox)GridView_Incoming_Defects.Rows[e.RowIndex].Cells[0].FindControl("TextBox_Invoice_No_Edit")).Text;
                    descr = ((TextBox)GridView_Incoming_Defects.Rows[e.RowIndex].Cells[0].FindControl("TextBox_Descr_Edit")).Text;
                    amount = ((TextBox)GridView_Incoming_Defects.Rows[e.RowIndex].Cells[0].FindControl("Textbox_Edit_Amount")).Text;                    
                    sev = ((DropDownList)GridView_Incoming_Defects.Rows[e.RowIndex].Cells[0].FindControl("DropDownList_Incm_Defect_Sev_Edit")).SelectedValue;
                    defectStat = ((DropDownList)GridView_Incoming_Defects.Rows[e.RowIndex].Cells[0].FindControl("DropDownList_Incm_Defect_Stat_Edit")).SelectedValue;
                    defectStatReason = ((TextBox)GridView_Incoming_Defects.Rows[e.RowIndex].Cells[0].FindControl("TextBox_Defect_Stat_Reason_Edit")).Text;
                    defectResolStat = ((DropDownList)GridView_Incoming_Defects.Rows[e.RowIndex].Cells[0].FindControl("DropDownList_Incm_Defect_Resol_Stat_Edit")).SelectedValue;
                    defectResolStatOld = ((Label)GridView_Incoming_Defects.Rows[e.RowIndex].Cells[0].FindControl("Label_Defect_Resol_Stat_Edit")).Text;
                    assgnTo = ((DropDownList)GridView_Incoming_Defects.Rows[e.RowIndex].Cells[0].FindControl("DropDownList_Incm_Defect_Assgn_To_Edit")).SelectedValue;
                    customerEntId = ((DropDownList)GridView_Incoming_Defects.Rows[e.RowIndex].Cells[0].FindControl("DropDownList_Incm_Defect_Cust_Det_Edit")).SelectedValue;
                    ...
                    dt.Rows[index]["CustName"] = ((DropDownList)GridView_Incoming_Defects.Rows[e.RowIndex].Cells[0].FindControl("DropDownList_Incm_Defect_Cust_Det_Edit")).SelectedItem.Text;
                    dt.Rows[index]["curr"] = ((DropDownList)GridView_Incoming_Defects.Rows[e.RowIndex].Cells[0].FindControl("DropDownList_Curr")).SelectedItem.Text;
                    ...
                    //if (!closeDateTime.Equals(""))
                        ...
                        targetVals.Add(BackEndObjects.DefectDetails.DEFECT_COL_CURRENCY, 
                            ((DropDownList)GridView_Incoming_Defects.Rows[e.RowIndex].Cells[0].FindControl("DropDownList_Curr")).SelectedValue);
                    //else
        ...
        {
            Dictionary<String, String> contactEmailList = (Dictionary<String, String>)ViewState["ReolveDefectContactEmailList"];
            ...
            if (contactEmailList == null || contactEmailList.Count == 0)
            {
                ...
                ViewState["ReolveDefectContactEmailList"] = contactEmailList;
            }
        ...
        protected void trySendEmail(String defId,String entId)
        {
            ...
            contactEmailList = (Dictionary<String, String>)ViewState["ReolveDefectContactEmailList"];
            if (mBEObj.getSupportEmail() != null && !mBEObj.getSupportEmail().Equals("") && contactEmailList != null)
            {
                try
                {
                    ActionLibrary.Emails.sendEmail(
                        ...
                        "Defect Resolved with defect id#" + defId,
                        mBEObj.getResolvedSupportEmailBody());
                }
                catch (Exception ex)
                {
                }
        ...
        protected void GridView_Outgoing_Defects_RowCancelingEdit(object sender, GridViewCancelEditEventArgs e)
        {
            GridView_Outgoing_Defects.EditIndex = -1;
            GridView_Outgoing_Defects.DataSource = (DataTable)Session[SessionFactory.ALL_DEFECT_ALL_OUTGOING_DEFECT_GRID];
            GridView_Outgoing_Defects.DataBind();
        }

        protected void GridView_Outgoing_Defects_RowEditing(object sender, GridViewEditEventArgs e)
        {
                        /*Dictionary<String, bool> accessList = (Dictionary<String, bool>)Session[SessionFactory.ACCESSLIST_FOR_USER];
                        ...
                        {*/
                            ...
                            GridView_Outgoing_Defects.EditIndex = e.NewEditIndex;
                            GridView_Outgoing_Defects.DataSource = (DataTable)Session[SessionFactory.ALL_DEFECT_ALL_OUTGOING_DEFECT_GRID];
                            GridView_Outgoing_Defects.DataBind();
                            Label_Outg_msg.Visible = true;
                            Label_Outg_msg.Text = "You can edit all the fields only if the defect is created by your organization";
        ...
        protected void GridView_Outgoing_Defects_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            String defectId = ((Label)GridView_Outgoing_Defects.Rows[e.RowIndex].Cells[0].FindControl("Label_Defect_Id")).Text;
            BackEndObjects.DefectDetails defObj = BackEndObjects.DefectDetails.getDefectDetailsbyidDB(defectId);
            ...
            int index = GridView_Outgoing_Defects.Rows[e.RowIndex].DataItemIndex;
            ...
            if (defObj.getCreationMode().Equals(BackEndObjects.DefectDetails.DEFECT_CREATION_MODE_MANUAL))
            {
               ...
               // if (defObj.getCreatedByComp().Equals(Session[SessionFactory.MAIN_BUSINESS_ENTITY_ID_STRING].ToString()))
                ...
                rfqNo = ((TextBox)GridView_Outgoing_Defects.Rows[e.RowIndex].Cells[0].FindControl("TextBox_RFQ_No_Edit")).Text;
                invNo = ((TextBox)GridView_Outgoing_Defects.Rows[e.RowIndex].Cells[0].FindControl("TextBox_Invoice_No_Edit")).Text;
                descr = ((TextBox)GridView_Outgoing_Defects.Rows[e.RowIndex].Cells[0].FindControl("TextBox_Descr_Edit")).Text;
                amount = ((TextBox)GridView_Outgoing_Defects.Rows[e.RowIndex].Cells[0].FindControl("Textbox_Edit_Amount")).Text;
                sev = ((DropDownList)GridView_Outgoing_Defects.Rows[e.RowIndex].Cells[0].FindControl("DropDownList_Outgoing_Defect_Sev")).SelectedValue;
                defectStat = ((DropDownList)GridView_Outgoing_Defects.Rows[e.RowIndex].Cells[0].FindControl("DropDownList_Outgoing_Defect_Stat_Edit")).SelectedValue;
                defectStatReason = ((TextBox)GridView_Outgoing_Defects.Rows[e.RowIndex].Cells[0].FindControl("TextBox_Defect_Stat_Reason_Edit")).Text;
                defectResolStat = ((DropDownList)GridView_Outgoing_Defects.Rows[e.RowIndex].Cells[0].FindControl("DropDownList_Outgoing_Defect_Resol_Stat_Edit")).SelectedValue;
                defectResolStatOld = ((Label)GridView_Outgoing_Defects.Rows[e.RowIndex].Cells[0].FindControl("Label_Defect_Resol_Stat_Edit")).Text;
                suplEntId = ((DropDownList)GridView_Outgoing_Defects.Rows[e.RowIndex].Cells[0].FindControl("DropDownList_Outgoing_Defect_Supplier_Edit")).SelectedValue;
                //assgnTo = ((DropDownList)GridView_Outgoing_Defects.Rows[e.RowIndex].Cells[0].FindControl("DropDownList_Outgoing_Defect_Assgn_To_Edit")).SelectedValue;
                    ...
                    dt.Rows[index]["Defect_Stat_Reason"] = defectStatReason;
                    dt.Rows[index]["Defect_Resol_Stat"] = defectResolStat;
                    dt.Rows[index]["SuplName"] = ((DropDownList)GridView_Outgoing_Defects.Rows[e.RowIndex].Cells[0].FindControl("DropDownList_Outgoing_Defect_Supplier_Edit")).SelectedItem.Text; ;
                    dt.Rows[index]["curr"] = ((DropDownList)GridView_Outgoing_Defects.Rows[e.RowIndex].Cells[0].FindControl("DropDownList_Curr")).SelectedItem.Text;
                ...
                //if(!closeDateTime.Equals(""))
                    targetVals.Add(BackEndObjects.DefectDetails.DEFECT_COL_CLOSE_DATE, closeDateTime);
                    targetVals.Add(BackEndObjects.DefectDetails.DEFECT_COL_CURRENCY,
                        ((DropDownList)GridView_Outgoing_Defects.Rows[e.RowIndex].Cells[0].FindControl("DropDownList_Curr")).SelectedValue);
        ...
        protected void GridView_Outgoing_Defects_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow && (e.Row.RowState & DataControlRowState.Edit) == DataControlRowState.Edit)
            {
                GridViewRow gVR = e.Row;
        ...
        {
            String forwardString = "/Pages/DispAudit.aspx";
            forwardString += "?contextId1=" + ((Label)GridView_Outgoing_Defects.SelectedRow.Cells[0].FindControl("Label_Defect_Id")).Text;
            forwardString += "&contextId2=" + "";
            forwardString += "&contextId3=" + "";

            ScriptManager.RegisterStartupScript(this, typeof(string), "DispOutgDefectAudit", "window.open('" + forwardString + "',null,'resizeable=yes,scrollbars=yes,addressbar=no,toolbar=no,width=900,Height=700');", true);
...
Session[SessionFactory.MAIN_BUSINESS_ENTITY_ID_STRING].ToString());
        ...
        {
            Session[SessionFactory.ALL_DEFECT_OUTG_SELECTED_SUPPLIER_OBJ] =
ActionLibrary.customerDetails.getContactDetails(((Label)GridView_Outgoing_Defects.SelectedRow.Cells[0].FindControl("Label_EntId")).Text,
Session[SessionFactory.MAIN_BUSINESS_ENTITY_ID_STRING].ToString());
        ...
        protected void Button_Incm_Doc_Click(object sender, EventArgs e)
        {
            ...
            String docName = ((Label)GridView_Incoming_Defects.SelectedRow.Cells[0].FindControl("Label_Doc_Name_Hidden")).Text;
            String defId = ((Label)GridView_Incoming_Defects.SelectedRow.Cells[0].FindControl("Label_Defect_Id")).Text;

            forwardString += "?contextId=" + "incoming";
            forwardString += "&contextId1=" + defId;
            forwardString += "&contextId2=" + docName;
            forwardString += "&dataItemIndex=" + GridView_Incoming_Defects.SelectedRow.DataItemIndex;


            ScriptManager.RegisterStartupScript(this, typeof(string), "IncmDefDoc",
        ...
        {
            String forwardString = "/Pages/Popups/Defects/AllDocs_Defect.aspx";
            String docName = ((Label)GridView_Outgoing_Defects.SelectedRow.Cells[0].FindControl("Label_Doc_Name_Hidden")).Text;
            String defId = ((Label)GridView_Outgoing_Defects.SelectedRow.Cells[0].FindControl("Label_Defect_Id")).Text;

            forwardString += "?contextId=" + "outgoing";
            forwardString += "&contextId1=" + defId;
            forwardString += "&contextId2=" + docName;
            forwardString += "&dataItemIndex=" + GridView_Outgoing_Defects.SelectedRow.DataItemIndex;

            ScriptManager.RegisterStartupScript(this, typeof(string), "OutgDefDoc",
                "window.open('" + forwardString + "',null,'resizeable=yes,scrollbars=yes,addressbar=no,toolbar=yes,width=900,Height=400');", true);
        ...
        protected void LinkButton_Supplier_Command(object sender, CommandEventArgs e)
        {
            ...
            ScriptManager.RegisterStartupScript(this, typeof(string), "OutgDefContact",
                "window.open('" + forwardString + "',null,'resizeable=yes,scrollbars=yes,addressbar=no,toolbar=no,width=900,Height=400');", true);
        }
        ...
        protected void Button_Notes_Outg_Def_Click(object sender, EventArgs e)
        {
            ...
            String rfqId = ((Label)GridView_Outgoing_Defects.SelectedRow.Cells[0].FindControl("Label_Defect_Id")).Text;

            forwardString += "?contextId=" + rfqId;

            ScriptManager.RegisterStartupScript(this, typeof(string), "OutgDefNotes",
        ...
        protected void GridView_Incoming_Defects_Sorting(object sender, GridViewSortEventArgs e)
        {
            ...
            Session[SessionFactory.ALL_DEFECT_ALL_INCOMING_DEFECT_GRID] = sortedTable;
        ...
        protected void GridView_Outgoing_Defects_Sorting(object sender, GridViewSortEventArgs e)
        {
            string sortExpression = e.SortExpression;
            ...
            DataTable sortedTable = dt.DefaultView.ToTable();
            Session[SessionFactory.ALL_DEFECT_ALL_OUTGOING_DEFECT_GRID] = sortedTable;
            GridView_Outgoing_Defects.SelectedIndex = -1;
            disableOnPageChange("outg");
            bindSortedData(GridView_Outgoing_Defects, sortedTable);
        ...
        protected void LinkButton_Assgn_To_Command(object sender, CommandEventArgs e)
        {
            ...
            ScriptManager.RegisterStartupScript(this, typeof(string), "userDetIncmDef",
   ...
   "window.open('" + forwardString + "',null,'resizeable=yes,scrollbars=yes,addressbar=no,toolbar=yes,width=800,height=800,left=500,right=500');", true);
        ...
        protected void Link_Descr_Short_Click(object sender, EventArgs e)
        {
            ...
            Label_Description.Text = ((LinkButton)GridView_Incoming_Defects.SelectedRow.Cells[0].FindControl("Link_Descr")).Text;
        }
        ...
        protected void Link_Descr_Short_Click_Outg(object sender, EventArgs e)
        {
            ...
            Panel_Description.Visible = true;
            Label_Description.Text = ((LinkButton)GridView_Outgoing_Defects.SelectedRow.Cells[0].FindControl("Link_Descr")).Text;
        }
    }
}