...
{
    public partial class AllDefectsContacts : System.Web.UI.Page
    {
        ...
        protected void fillCustData()
        {
            ...
            Dictionary<String, Object> custObj=null;

            if(context.Equals("incoming"))
            custObj = (Dictionary<String, Object>)Session[SessionFactory.ALL_DEFECT_INCM_SELECTED_CUSTOMER_OBJ];
            else if(context.Equals("outgoing"))
                custObj = (Dictionary<String, Object>)Session[SessionFactory.ALL_DEFECT_OUTG_SELECTED_SUPPLIER_OBJ];            
            else if(context.Equals("incomingSR"))
                custObj = (Dictionary<String, Object>)Session[SessionFactory.ALL_SR_INCM_SELECTED_CUSTOMER_OBJ];
            else if(context.Equals("outgoingSR"))
                custObj = (Dictionary<String, Object>)Session[SessionFactory.ALL_SR_INCM_SELECTED_CUSTOMER_OBJ];
