...
namespace OnLine.Pages
{
    ...
    getAllShopChildProdObjsbyEntId(Session[SessionFactory.MAIN_BUSINESS_ENTITY_ID_STRING].ToString());
        ...
        protected void fillGrid()
        {
            ...
            if(Session[SessionFactory.CREATE_LEAD_SELECTED_PRODUCT_CAT]!=null && !Session[SessionFactory.CREATE_LEAD_SELECTED_PRODUCT_CAT].Equals(""))
            selectedProdCatId=Session[SessionFactory.CREATE_LEAD_SELECTED_PRODUCT_CAT].ToString();
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected void Button_Submit_Lead_Click(object sender, EventArgs e)
        {
            Button_Submit_Next0.Enabled = false;
        ...
        protected void Button_Submit_Lead_Next(object sender, EventArgs e)
        {
            generateLead();
        ...
        protected void DropDownList_Level1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            DropDownList_Level2.SelectedIndex = -1;
            Session[SessionFactory.CREATE_LEAD_SELECTED_PRODUCT_CAT] = DropDownList_Level1.SelectedValue;
        ...
        protected void DropDownList_Level2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            DropDownList_Level3.SelectedIndex = -1;
            Session[SessionFactory.CREATE_LEAD_SELECTED_PRODUCT_CAT] = DropDownList_Level2.SelectedValue;
        }

        protected void DropDownList_Level3_SelectedIndexChanged(object sender, EventArgs e)
        {
            Session[SessionFactory.CREATE_LEAD_SELECTED_PRODUCT_CAT] = DropDownList_Level3.SelectedValue;
        }
        ...
        protected void DropDownList_Quote_Unit_SelectedIndexChanged(object sender, EventArgs e)
        {
            //Session[SessionFactory.CREATE_LEAD_QUOTE_UNIT] = DropDownList_Quote_Unit.SelectedValue;
        }
        ...
        protected void TextBox_Prod_Name_TextChanged(object sender, EventArgs e)
        {
            DropDownList_Prod_List.Enabled = TextBox_Prod_Name.Text.Trim().Equals("") ? true : false;
        }
