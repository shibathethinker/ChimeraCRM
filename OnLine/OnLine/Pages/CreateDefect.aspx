<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreateDefect.aspx.cs" Inherits="OnLine.Pages.CreateDefect" %>
...
<body>
    ...
    <br />
        ...
        <div class="panel-heading">
            <h3 class="style3">Enter New Defect</h3>
            </div>
    ...
    <asp:Panel ID="Panel2" runat="server" 
        ...
        <div class="panel-heading">
            <h3 class="panel-title">Defect Details</h3>
            </div>
            <div class="panel-body">    
        <asp:Panel ID="Panel_Defect_Det" runat="server" 
            ...
            <asp:hiddenfield id="hdnValueRFQ" onvaluechanged="hdnValue_ValueChangedRFQ" runat="server" />
                ...
                &nbsp;<asp:Label ID="Label_Defect_Descr" runat="server" 
                    Text="Enter Defect Description"></asp:Label>
        ...
        <div class="panel-info" Width="95%">
        <div class="panel-heading">
            <h3 class="panel-title">Defect Status Details</h3>
            </div>
            <div class="panel-body">   
        <asp:Panel ID="Panel_Defect_Stat" runat="server"  
            style="font-family: Andalus" >
            Defect Acknowlegement Status:
            ...
            <br />
            <br />
            Defect Status Justification:&nbsp;<asp:TextBox class="form-control" ID="TextBox_Resol_Stat_Reason" 
        ...
        <asp:Panel ID="Panel_Contacts" runat="server" 
            ...
            &nbsp;&nbsp;<asp:LinkButton ID="LinkButton1" runat="server" 
                 onclick="LinkButton1_Click" OnClientClick = "SetTarget();">Create New Account and Add to this Defect!</asp:LinkButton>
            &nbsp;&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator2" 
                runat="server" ControlToValidate="DropDownList_Contacts" Display="Dynamic" 
                ForeColor="Red" ValidationGroup="CreateLeadManual">Must select an account for manully created defect</asp:RequiredFieldValidator>
        </asp:Panel>
        </div>
        </div>
                    </ContentTemplate>
        ...
        <br />
                ...
                <div align="center">
                    ...
                    <asp:Button ID="Button_Submit_Defect" runat="server" 
                        ...
                        Text="Create Defect!" ValidationGroup="CreateDefect" 
