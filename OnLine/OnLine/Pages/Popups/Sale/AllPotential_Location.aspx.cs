...
{
    public partial class AllPotential_Location : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                else
                {
                    ...
                    Label_Status.Text = "You dont have edit access to Potential records";
                    Label_Status.ForeColor = System.Drawing.Color.Red;
                }

                String localId = Session[SessionFactory.ALL_SALE_ALL_POTENTIAL_LOCATION].ToString();
    ...
    !DropDownList_State.SelectedValue.Equals("") ? DropDownList_State.SelectedValue : DropDownList_Country.SelectedValue;
            ...
            try
            {
                ...
                Session[SessionFactory.ALL_SALE_ALL_POTENTIAL_LOCATION] = localId;
                loadLocalityDetails(localId);
            }
            catch (Exception ex)
            {
