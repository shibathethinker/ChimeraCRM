...
{
    public partial class AllLead_Location : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                else
                {
                    ...
                    Label_Status.Text = "You dont have edit access to Lead records";
                    Label_Status.ForeColor = System.Drawing.Color.Red;
                }

                String localId = Session[SessionFactory.ALL_SALE_ALL_LEAD_LOCATION].ToString();
    ...
    !DropDownList_State.SelectedValue.Equals("") ? DropDownList_State.SelectedValue : DropDownList_Country.SelectedValue;
            ...
            try
            {
                ...
                Session[SessionFactory.ALL_SALE_ALL_LEAD_LOCATION] = localId;
                loadLocalityDetails(localId);
            }
            catch (Exception ex)
            {
