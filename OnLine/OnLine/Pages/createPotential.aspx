<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="createPotential.aspx.cs" Inherits="OnLine.Pages.createPotential" %>
        ...
        .style3
       {
        ...
        <script language="javascript">
            function RefreshParent() {
                window.opener.document.getElementById('ContentPlaceHolderBody_Button_Potn_Refresh_Hidden').click();
            }
        </script>
</head>
<body>
    ...
    <div align="center">
        ...
        <div class="panel-heading">
            <h3 class="style3">Create New Potential</h3>
            </div>
    ...
    <asp:Panel ID="Panel2" runat="server" 
        ...
        <asp:Panel ID="Panel_Prod_Service_Det" runat="server"
            ...
            EditRowStyle-CssClass="sel"
                    ...
                    <Columns>
                        <asp:CommandField ShowSelectButton="True" SelectText="Add To Potential" />
        ...
        <asp:Panel ID="Panel_Prod_Srv_Qnty" runat="server"
            ...
            &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator_Qty_From" 
                ...
                ErrorMessage="Required" ForeColor="Red" ValidationGroup="Pot_Validate"></asp:RequiredFieldValidator>
            &nbsp;<asp:RegularExpressionValidator ID="RegularExpressionValidator1" 
                ...
                ValidationGroup="Pot_Validate"></asp:RegularExpressionValidator>
            To:&nbsp;<asp:TextBox class="form-control" ID="TextBox_Prod_Qnty_To" runat="server"  
                Width="20%" MaxLength="14"></asp:TextBox>
            &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator_Qty_To" runat="server" 
                ControlToValidate="TextBox_Prod_Qnty_To" Display="Dynamic" ErrorMessage="Required" 
                ForeColor="Red" ValidationGroup="Pot_Validate"></asp:RequiredFieldValidator>
            &nbsp;<asp:RegularExpressionValidator ID="RegularExpressionValidator2" 
                runat="server" ControlToValidate="TextBox_Prod_Qnty_To" Display="Dynamic" 
                ErrorMessage="Please enter valid number (maximum 11 digits before decimal and 2 after decimal)" 
                ForeColor="Red" ValidationExpression="^(?:[1-9]\d{0,10})?(?:\.\d{0,2})?$" 
                ValidationGroup="Pot_Validate"></asp:RegularExpressionValidator>
            Unit Of Measurement:
        ...
        <asp:Panel ID="Panel_Quote" runat="server" 
            ...
            <asp:TextBox class="form-control" ID="TextBox_Prod_Name" runat="server"  
                Height="28px" Width="20%"></asp:TextBox>
            &nbsp;or select from list:
        ...
        <asp:Panel ID="Panel_Contacts" runat="server" 
            ...
            &nbsp;
            <asp:LinkButton ID="LinkButton1" runat="server" onclick="LinkButton1_Click">Create New Account and Add to this Lead!</asp:LinkButton>
        </asp:Panel>
        </div>
        </div>
        ...
        <br />
                    <div class="panel-info" Width="95%">
        <div class="panel-heading">
            <h3 class="panel-title">Potential State and Stage</h3>
            </div>
            <div class="panel-body"> 
        <asp:Panel ID="Panel_Pot_State" runat="server"  
            style="font-family: Andalus" >
            Potential Stage:
            ...
            &nbsp;Potential State:
            <asp:DropDownList class="form-control form-control-dropdown" ID="DropDownList_Pot_State" runat="server" 
                AutoPostBack="True" 
                onselectedindexchanged="DropDownList_State_SelectedIndexChanged" 
                style="font-family: Andalus">
            </asp:DropDownList>
        ...
        <ajaxtoolkit:CalendarExtender Enabled="false" ID="TextBox_Fwp_Date_CalendarExtender" 
            ...
            TargetControlID="TextBox_Fwp_Date">
        </ajaxtoolkit:CalendarExtender>
        ...
        &nbsp;
        <asp:RequiredFieldValidator ID="RequiredFieldValidator_Pot_Name" runat="server" 
            ControlToValidate="TextBox_Reqr_Name" Display="Dynamic" ErrorMessage="Required" 
            ForeColor="Red" ValidationGroup="Pot_Validate"></asp:RequiredFieldValidator>
        <br />
        <br />
                            <div class="panel-info" Width="95%">
        <div class="panel-heading">
            ...
            <div class="panel-body"> 
        <asp:Panel ID="Panel_Terms_Conds" runat="server" 
            style="font-family: Andalus" >
            Upload Documnet:
        ...
        <br />
                ...
                <div align="center">
                    <asp:Button ID="Button_Submit_Pot" runat="server" class="btn btn-sm btn-success"
                        onclick="Button_Submit_Pot_Click" style="font-family: Andalus" Text="Submit!" 
                        ValidationGroup="Pot_Validate" />
                    ...
                    &nbsp;&nbsp;<asp:Button ID="Button_Submit_Extra_Prd_Srv" runat="server" class="btn btn-sm btn-success"
                        ...
                        Text="Add More Products/Services To This Potential!" 
                    ...
                    <asp:Button ID="Button_Submit_Next" runat="server" class="btn btn-sm btn-success"
                        ...
                        Text="Submit and Next!" ValidationGroup="Pot_Validate" />
