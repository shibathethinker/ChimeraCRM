...
{
    public partial class AllLead_NDA : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                else
                {
                    ...
                    Label_Upload_Stat.Text = "You dont have edit access to Lead records";
                    Label_Upload_Stat.Visible = true;
                    Label_Upload_Stat.ForeColor = System.Drawing.Color.Red;
                }

                RFQDetails rfqObj=RFQDetails.getRFQDetailsbyIdDB(Session[SessionFactory.ALL_SALE_ALL_LEAD_SELECTED_LEAD_ID].ToString());
                String docName = "";
                ...
                RFQResponse respObj = RFQResponse.getRFQResponseforRFQIdandResponseEntityIdDB(Session[SessionFactory.ALL_SALE_ALL_LEAD_SELECTED_LEAD_ID].ToString(), Session[SessionFactory.MAIN_BUSINESS_ENTITY_ID_STRING].ToString());
    ...
    Split(new String[] { "\\" }, StringSplitOptions.RemoveEmptyEntries);
        ...
        {
            RFQResponse respObj = RFQResponse.getRFQResponseforRFQIdandResponseEntityIdDB(Session[SessionFactory.ALL_SALE_ALL_LEAD_SELECTED_LEAD_ID].ToString(),
            ...
            try
            {
                ...
                else
                {
                    ...
                    respObj.setRFQId(Session[SessionFactory.ALL_SALE_ALL_LEAD_SELECTED_LEAD_ID].ToString());
