...
{
    public partial class AllContacts_Location : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                String localId = BackEndObjects.Contacts.
                    getContactDetailsforContactEntityDB(Session[SessionFactory.MAIN_BUSINESS_ENTITY_ID_STRING].ToString(), contactEntId).getLocalityId();
    ...
    !DropDownList_State.SelectedValue.Equals("") ? DropDownList_State.SelectedValue : DropDownList_Country.SelectedValue;
            ...
            targetVals.Add(BackEndObjects.Contacts.CONTACT_TABLE_COL_LOCALITY_ID, localId);
