    ...
    <div>
        ...
        <br />
            ...
            <asp:Panel ID="Panel1" runat="server" BorderColor="#0066CC" BorderStyle="Ridge" 
                ...
                &nbsp; Passsword:
                <asp:TextBox class="form-control" ID="TextBox2" TextMode="Password" runat="server"  Width="219px"></asp:TextBox>
                &nbsp;
                ...
                <br />
                Confirm Password:
                <asp:TextBox class="form-control" ID="TextBox3" TextMode="Password" runat="server"  Width="258px"></asp:TextBox>
