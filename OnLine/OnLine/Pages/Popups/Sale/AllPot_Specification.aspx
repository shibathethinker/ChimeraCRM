<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AllPot_Specification.aspx.cs" Inherits="OnLine.Pages.Popups.Sale.AllPot_Specification" %>
...
<body>
    ...
    <div align="center">
        ...
        <asp:Label ID="Label_Status" runat="server" Visible="False"></asp:Label>
                    ...
                    GridLines="None" 
                                        CCssClass="table table-striped table-bordered table-hover tableShadow" 
        ...
        <asp:Panel ID="Panel_Prod_Service_Det" runat="server" 
            ...
            <div>
                ...
                <div align="center">
                    ...
                    <Columns>
                        <asp:CommandField SelectText="Add To Potn" ShowSelectButton="True" />
                        <asp:TemplateField HeaderText="Hidden">
                            <ItemTemplate>
